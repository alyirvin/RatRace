...
const ClaimRatOne = ({ onDialogueData }: RemiIntroProps) => {
    const [currentDialogue, setCurrentDialogue] = useState("Hello? Hello can you hear me?");
    ...
    const allDialogueOptions: Record<string, DialogueOption[]> = {
        ...
        solutions: [
            ...
            },
            {
                ...
                response: "OMG Rude!! Do you not realize how expense my stuff in there was and it's all ruined!",
                nextStage: "end"
            }
        ]
    };
